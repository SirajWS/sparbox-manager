...
const dictionaries = {
  ...
  fr: {
    ...
    booking_hint: 'Pas de bouton Enregistrer : l’écriture est enregistrée dès que tous les champs obligatoires sont remplis. Pour le montant, appuyez sur Entrée ou quittez le champ.',
    ledger: 'Livre',
    ...
    remove: 'Supprimer',
    confirm_remove_booking: 'Supprimer l’écriture de {amount} ?',
